...
type AnyKeyValueTuple = [any, any] | readonly [any, any];

Define(Array.prototype, "toMap", function (result?: Map<any, any> | ((value: any, index: number) => AnyKeyValueTuple), mapper?: (value: any, index: number) => AnyKeyValueTuple): any {
